...
export const status = {
    ...
    SIGNIN_SUCCESS: {status: StatusCodes.OK, "isSuccess": true, "code": 2000, "message": "회원가입 완료!"},
    ...
    PARAMETER_IS_WRONG: {status: StatusCodes.BAD_REQUEST, "isSuccess": false, "code": "COMMON005", "message": "잘못된 파라미터입니다."},
    ...
    STORE_NOT_FOUND: {status: StatusCodes.BAD_REQUEST, "isSuccess": false, "code": "STORE4001", "message": "가게가 없습니다."},
    EMAIL_ALREADY_EXIST: {status: StatusCodes.BAD_REQUEST, "isSuccess": false, "code": "STORE4003", "message": "이메일 중복입니다."},
